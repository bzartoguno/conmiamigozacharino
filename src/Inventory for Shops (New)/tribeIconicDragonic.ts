...
When the boots' property has been used for a total of 10 minutes, the magic ceases to function until you finish a long rest.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `This fine leather bridle tugs at the hand when first held, as though it longs to reach out for a beast nearby. When you hold one end of the bridle, you can use an action to speak its command word, causing the other end to lash out at a beast you can see within 20 feet of you. The target must succeed on a DC 17 Charisma saving throw or have the bridle tie itself around its neck, then fall under your command as if subjected to the Dominate Beast spell. Once the targeted is affected, you do not need to hold the other end of the bridle to command it. With a successful saving throw, the target becomes immune to the bridle’s power until the next dawn.
A creature controlled by the bridle can be released by the creature that bound it as a bonus action. A creature controlled by the bridle can make a DC 17 Charisma check each day at dawn. On a success, the creature is no longer affected by the bridle.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `This magic rose comes in one of five colors, as noted in the Chromatic Roses table. While a rose is held, it gains a harmless visual effect as indicated on the table.
...
While wearing the cloak in an area of dim light or darkness, you can use your action to cast Polymorph on yourself, transforming into a bat. While you are in the form of the bat, you retain your Intelligence, Wisdom, and Charisma scores. The cloak can't be used this way again until the next dawn.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This jagged iron circlet bears ornaments in the shape of the enemy rune. When worn, the crown glows with pale light as it draws upon the wearer’s fury to strike opponents with vicious terror.
...
Invoking the Rune. As an action, you can invoke the crown’s rune to cast the Fear spell (save DC 15) with it; the spell has a duration of 1 minute and doesn’t require concentration. Once the rune has been invoked, it can’t be invoked again until the next dawn.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: "This finely detailed belt is made of dragonhide. While wearing it, you gain a bonus to the saving throw DCs of your ki features. The bonus is determined by the belt’s rarity. In addition, you can use an action to regain ki points equal to a roll of your Martial Arts die. You can’t use this action again until the next dawn. (This is a +2 item I don't know where to put it)",
    },
    {
...
-You can summon a steam mephit as an action (3 charges). The mephit is friendly to you, obeys your verbal commands, and acts on its own turn in the initiative order. It disappears in a harmless puff of steam after 1 minute or if it ends its turn more than 60 feet from the pipe.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This dark cloak is made of cured hell hound hide. As an action, you can command the cloak to transform you into a hell hound for up to 1 hour. The transformation otherwise functions as the Polymorph spell, but you can use a bonus action to revert to your normal form.
...
Once the bands are used, they can't be used again until the next dawn.`,
    ...
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `These gemstones contain a crystallized bit of spellcasting magic. Different types of mind crystals exist, each with a different single-use effect.
...
Quickened (Rare). You change the spell’s casting time to 1 bonus action for this casting.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `This short tube, about 2 feet long and 6 inches in diameter, is made from mizzium, a magically enhanced metal alloy forged by the lzzet League. The end that's pointed toward a target is open, and a glowing ball of molten metal can be seen at the other end as long as the mortar has at least 1 charge remaining.
...
Mizzium Bombared. You can expend 3 charges as an action to launch a hail of molten projectiles in a 20-foot-radius, 40-foot-high cylinder centered on a point you can see within 60 feet of you. Each creature in the area must make a DC 15 Dexterity saving throw. A creature takes 5d8 fire damage on a failed save, or half as much damage on a successful one.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: "This cloak is a Cloak of Elvenkind. It also grants you resistance to fire damage while you wear it. It loses its magic if exposed to sunlight for 1 hour without interruption.",
    },
    {
      name: "Robe of Eyes",
      rarity: "Rare",
...
A Light spell cast on the robe or a Dayight spell cast within 5 feet of the robe causes you to be blinded for 1 minute. At the end of each of your turns, you can make a Constitution saving throw (DC 11 for Light or DC 15 for Dayight), ending the blindness on a success.`,
    },
    {
      name: "Robe of Summer",
      rarity: "Rare",
...
When you use a Metamagic option on a spell while you are holding or wearing the shard, you can momentarily curse one creature targeted by the spell; choose one ability score, and until the end of your next turn, the creature has disadvantage on ability checks and saving throws that use that ability.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This pair of boots is made of durable cloth, with the journey rune stitched in golden thread above each heel. While you are wearing this item, your walking speed increases by 10 feet, and you have advantage on Wisdom (Survival) checks.
Invoking the Runes. As a bonus action, you can invoke the boots’ runes to cast the Expeditious Retreat spell with them. Once the runes have been invoked, they can’t be invoked again until the next dawn.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `This is not a subtle headpiece. The metal is mirror-bright, the points curve like dragon horns. In sunlight it throws little prismatic flares that make the wearer look like they’re standing on a stage.
...
-You can tolerate temperatures as low as -50 degrees Fahrenheit without any additional protection. If you wear heavy clothes, you can tolerate temperatures as low as -100 degrees Fahrenheit.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `Produced by a special needle, this magic tattoo has long intertwining designs.
...
Grasping Tendrils. While the tattoo is on your skin, you can, as an action, cause the tattoo to extrude into inky tendrils, which reach for a creature you can see within 15 feet of you. The creature must succeed on a DC 14 Strength saving throw or take 3d6 force damage and be grappled by you. As an action, the creature can escape the grapple by succeeding on a DC 14 Strength (Athletics) or Dexterity (Acrobatics) check. The grapple also ends if you halt it (no action required), if the creature is ever more than 15 feet away from you, or if you use this tattoo on a different creature.`,
    },
    {
      ...
      attunment: true,
      price: 250,
      description: "This finely detailed belt is made of dragonhide. While wearing it, you gain a bonus to the saving throw DCs of your ki features. The bonus is determined by the belt’s rarity. In addition, you can use an action to regain ki points equal to a roll of your Martial Arts die. You can’t use this action again until the next dawn. (This is a +1 item I don't know where to put it)",
    },
    {
...
You can speak another command word as an action to make the illuminated globe rise into the air and float no more than 5 feet off the ground. The globe hovers in this way until you or another creature grasps it. If you move more than 60 feet from the hovering globe, it follows you until it is within 60 feet of you. It takes the shortest route to do so. If prevented from moving, the globe sinks gently to the ground and becomes inactive, and its light winks out.`,
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `Produced by a special needle, this magic tattoo depicts clawlike forms and other jagged shapes.
Tattoo Attunement. To attune to this item, you hold the needle to your skin where you want the tattoo to appear, pressing the needle there throughout the attunement process. When the attunement is complete, the needle turns into the ink that becomes the tattoo, which appears on the skin.
If your attunement to the tattoo ends, the tattoo vanishes, and the needle reappears in your space.
...
Eldritch Maul. As a bonus action, you can empower the tattoo for 1 minute. For the duration, each of your melee attacks with a weapon or an unarmed strike can reach a target up to 15 feet away from you, as inky tendrils launch toward the target. In addition, your melee attacks deal an extra 1d6 force damage on a hit. Once used, this bonus action can't be used again until the next dawn.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `These symbiotic gloves — made of thin chitin and sinew — pulse with a life of their own. To attune to them, you must wear them for the entire attunement period, during which the gloves bond with your skin.
...
Extended (Uncommon). If the spell has a duration of 1 minute or longer, double the spell’s duration, to a maximum duration of 24 hours.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `A Robe of Serpents is a stylish silk garment that is popular among wealthy nobles and retired assassins. The robe is emblazoned with 1d4 + 3 stylized serpents, all brightly colored.
...
The boots regain 2 hours of flying capability for every 12 hours they aren't in use.`,
    },
    {
      ...
      attunment: false,
      price: 250,
      description: `A mesmerizing purple silk robe with white trim, though in some upper circles this item is considered illegal, but for you dear adventurer I won't mind if you take it off my hands.
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: `This wand looks like polished bone or silverwood, etched with tiny crescent-scale motifs. In dim light, the engravings resemble a shifting star map.
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: `A heavy gold chain holds a tiny dark crystal hourglass filled with glittering gold sand. 
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: `A thumb-sized rainbow crystal shard set in a sleek silver frame. When you finish a long rest, choose one mode for the talisman until your next long rest:
...
You can use an action to cast the Web spell (save DC 13). The web created by the spell fills twice its normal area. Once used, this property of the cloak can't be used again until the next dawn.`,
    },
    {
      ...
      attunment: false,
      price: 2500,
      description: `This deck of heavy vellum cards hums with the magic of the Elemental Chaos.
...
4	♠️ (Swords)	The card unleashes a sharp, concussive blast. The target and each creature within 5 feet of it take 1d6 force damage and must succeed on a DC 15 Strength saving throw or have the prone condition.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: "This finely detailed belt is made of dragonhide. While wearing it, you gain a bonus to the saving throw DCs of your ki features. The bonus is determined by the belt’s rarity. In addition, you can use an action to regain ki points equal to a roll of your Martial Arts die. You can’t use this action again until the next dawn. (This is a +3 item I don't know where to put it)",
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: "While you wear this adamantine crown, you have advantage on Intelligence, Wisdom, and Charisma saving throws, and you have resistance to psychic damage.",
    },
    {
...
While you wear the robe, you can use an action to enter the Astral Plane along with everything you are wearing and carrying. You remain there until you use an action to return to the plane you were on. You reappear in the last space you occupied, or if that space is occupied, the nearest unoccupied space.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This shard of ice is long and slender, roughly the size of a dagger. The ise (ice) rune glows within it. The shard has the following properties, which work only while it's on your person.
Frigid Touch.
...
The pair of boots is now a rare magic item that requires attunement. While wearing it, you ignore difficult terrain while walking, and you can walk on water.`,
    },
    {
      ...
      attunment: false,
      price: 2500,
      description: `These earrings have three modes, each activated as an action, and each effect is centered on your current location when you activate it. Once chosen, that mode’s terrain effect lingers where it was created; it doesn’t “follow” you unless a mode explicitly says it does. These are meant to feel like you’re dropping a dramatic environmental set-piece onto the scene.
