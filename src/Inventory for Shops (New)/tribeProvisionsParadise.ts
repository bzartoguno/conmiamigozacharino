...
Subtle (Common). You cast the spell without any somatic or verbal components for this casting.`,
    },
    {
      ...
      attunment: false,
      price: 40,
      description: `Produced by a special needle, this magic tattoo contains a single spell of up to 5th level, wrought on your skin by a magic needle. To use the tattoo, you must hold the needle against your skin and speak the command word. The needle turns into ink that becomes the tattoo, which appears on the skin in whatever design you like. Once the tattoo is there, you can cast its spell, requiring no material components. The tattoo glows faintly while you cast the spell and for the spell's duration. Once the spell ends, the tattoo vanishes from your skin.
...
=====
Bags of holding can also preserve bodies! But the drawback is you can hold up to a certain amount of CR monsters based on your highest stat times by 10, so like if you want to keep a bunch of dead elephants (CR 4) for some reason and your highest stat was like +4 that would be like 10*4 = 40 meaning you can only hold up to ten elephant and no other monster bodies (monster body parts and aspects are different and don't count against this)`,
    },
    {
      name: "Bag of Tricks",
      rarity: "Uncommon",
