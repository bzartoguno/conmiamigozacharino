...
export const tribeSleuthUniversity: Tribe & { items: SleuthUniversityItem[] } = {
  ...
  insults: [
          ...
          "They say the pen is mighter then the sword, but I have swung a sword at 50 pens and I can conferm that it is not the case.",
          "Back in my glory days I use to travel around with on Professor Layton, oh the things we would get up to. Tho if I must pass down a word of advice from that time. If someone is about to grab you, set your self on fire. They'll never see it coming",
          "I actaully teamed up with Benjamen Fanklin once not a bad guy really but he kept on saying 'who are you' 'where are we going' 'put me down' ",
          "I can't wait to clock out, and go home to see my beloved Yoshi. Oh um he's a velociraptor, I taught him how to skateboard.",
          "Sometimes the world can be quite confusing that why here at Sleuth University we can help you understand it a bit better!",
          "Oh good heavens! I've lost track of time! Oh tea and crumb pits, and other brithish sounding things. I- umm yes indeed you look like a very scary chap! Pray tell would you be willing to lend me your skill? I need to teach a small session on how to properly terrify the lights out of somebody and you look like you've seen that sort of thing. If your willing to come with me and make a DC 14 Intimidation check to teach the next generation I'll be most pleased. If you succeed, I’ll pay you 25 gp for your time. If you fail, you take 1 point of damage as you get mocked by college students and get 25 gp for the trouble.",
          ],
  items: [
    {
      name: "Lost & Found",
