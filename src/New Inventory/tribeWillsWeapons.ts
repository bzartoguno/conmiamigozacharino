...
export const tribeWillsWeapons: Tribe = {
  ...
  items: [
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "(Obsidian Spiked) (+DEX or STR to hit + (Proficiency if you have it for this item) Dealing your DEX or STR + 3d6, Slashing. Do to this weapons heavy blunt nature, if you have EXPERTISE with this weapon, when deal a blow getting a creature to under half health you can stun that creature.)",
    },
    {
      name: "Will's Musket",
      rarity: "Uncommon",
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "(Glaive-Spear) (+DEX or STR to hit + (Proficiency if you have it for this item) Dealing your DEX or STR + 3d8, Slashing. Do to this weapons long nature, if you have EXPERTISE with this weapon, you can attack creatures up to 10 feet away from you.)",
    },
    {
      name: "Will's Pistol",
      rarity: "Uncommon",
    ...
    },
    {
      name: "Armblade",
      rarity: "Common",
      itemType: "Weapon (Single hand)",
      attunment: true,
      price: 40,
      description: `An armblade is a magic weapon that attaches to your arm, becoming inseparable from you as long as you're attuned to it. To attune to this item, you must hold it against your forearm for the entire attunement period.
...
Whenever a hostile creature damages you while the axe is in your possession, you must succeed on a DC 15 Wisdom saving throw or go berserk. While berserk, you must use your action each round to attack the creature nearest to you with the axe. If you can make extra attacks as part of the Attack action, you use those extra attacks, moving to attack the next nearest creature after you fell your current target. If you have multiple possible targets, you attack one at random. You are berserk until you start your turn with no creatures within 60 feet of you that you can see or hear.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This magic sword’s blade is fashioned from a horn or spine from a crystal dragon. When you hit with an attack roll using this sword, the target takes an extra 1d8 radiant damage.
...
Stirring (Rare). The Stirring weapon has the Slumbering property. In addition, you gain a +1 bonus to attack and damage rolls made using the weapon. On a hit, the weapon deals an extra 1d6 damage of the type dealt by the dragon’s breath weapon.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `A dagger fashioned from the tooth of a dragon. While the blade is obviously a fang or predator's tooth, the handle is leather wrapped around the root of the tooth, and there is no cross-guard.
...
An Aberration hit with this greataxe takes an extra 1d12 slashing damage. If the Aberration is currently grappling a creature, the Aberration must succeed on a DC 15 Strength saving throw or release each creature it is grappling.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `Choose a magical bonus of +1 to +3. This sword gains that bonus to its attack and damage rolls. For each point of bonus you choose for the sword, you take a corresponding penalty (−1 to −3) to your death saving throws. You can change this magical bonus each day at dawn.
...
While you hold this weapon, it sheds bright light in a 20-foot radius and dim light for an additional 20 feet.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `You gain a +1 bonus to attack and damage rolls made with this magic weapon. The bonus increases to +3 when you use this mace to attack a construct.
...
When you cast a spell that restores hit points, you can roll a d4 and add the number rolled to the amount of hit points restored, provided you are holding the sickle. (This is a +2 weapon)`,
    },
    {
...
Slumbering (Uncommon). Whenever you roll a 20 on your attack roll with this weapon, each creature of your choice within 5 feet of the target takes 5 damage of the type dealt by the dragon’s breath weapon.`,
    },
    {
      ...
      attunment: false,
      price: 250,
      description: `This weapon is fashioned from infernal iron and traced with veins of hellfire that shed dim light in a 5-foot-radius.
...
The javelin's property can't be used again until the next dawn. In the meantime, the javelin can still be used as a magic weapon.`,
    },
    {
      ...
      price: 250,
      description: `This silver-bladed sickle glimmers softly with moonlight. While holding this magic weapon, you gain a bonus to attack and damage rolls made with it, and you gain a bonus to spell attack rolls and the saving throw DCs of your druid and ranger spells. The bonus is determined by the weapon's rarity. In addition, you can use the sickle as a spellcasting focus for your druid and ranger spells.
When you cast a spell that restores hit points, you can roll a d4 and add the number rolled to the amount of hit points restored, provided you are holding the sickle. (This is a +1 weapon)`,
    },
    {
      name: "Seeker Dart",
      rarity: "Uncommon",
...
When the dart reaches its target, the target must succeed on a DC 16 Dexterity saving throw or take 1d4 piercing damage and 3d4 lightning damage. The dart’s magic is then spent, and it becomes an ordinary dart.`,
    },
    {
      ...
      attunment: true,
      price: 250,
      description: "You have a +1 bonus to attack and damage rolls you make with this magic weapon. If it hits an object, the hit is automatically a critical hit, and it can deal bludgeoning or slashing damage to the object (your choice). Further, damage from nonmagical sources can't harm the weapon.",
    },
    {
...
You can break the curse in the usual ways. Alternatively, casting Banishment on the sword forces the vengeful spirit to leave it. The sword then becomes a +1 weapon with no other properties.`,
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon's rarity. (This is a +1 item)",
    },
    {
...
Curse. This weapon is cursed, and becoming attuned to it extends the curse to you. Until the curse is broken with a Remove Curse spell or similar magic, you are unwilling to part with the weapon. Whenever you attack a creature with this weapon and roll a 1 on the attack roll, you must succeed on a DC 15 Constitution saving throw or be restrained and forced to make additional saves against being petrified, as above.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `The hilt of this sword bears a carnelian engraved with the blood rune.
...
Once the rune has been invoked, it can’t be invoked again until the next dawn.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This bow has multiple strings and resembles a lyre or small harp. By strumming the strings while setting an arrow to the bow, you imbue the arrow with magic.
...
Symbiotic Nature. The whip can't be removed from you while you're attuned to it, and you can't voluntarily end your attunement to it. If you're targeted by a spell that ends a curse, your attunement to the whip ends, and it detaches from you.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This weapon appears ordinary, but it bears strong illusion magic that allows its wielder to skillfully deceive opponents.
...
Additionally, while attuned to the weapon, you can cast
Dancing Lights
from the musket at will.
Invoking the Rune.
As an action, you can invoke the weapon’s rune to cast the
Sunbeam
spell (save DC 17) with it. Once the rune has been invoked, it can’t be invoked again until the next dawn.`,
    },
    {
      name: "Moon Sickle",
      rarity: "Very Rare",
      ...
      price: 2500,
      description: `This silver-bladed sickle glimmers softly with moonlight. While holding this magic weapon, you gain a bonus to attack and damage rolls made with it, and you gain a bonus to spell attack rolls and the saving throw DCs of your druid and ranger spells. The bonus is determined by the weapon's rarity. In addition, you can use the sickle as a spellcasting focus for your druid and ranger spells.
When you cast a spell that restores hit points, you can roll a d4 and add the number rolled to the amount of hit points restored, provided you are holding the sickle. (This is a +3 weapon)`,
    },
    {
...
While your sworn enemy lives, you have disadvantage on attack rolls with all other weapons.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `When you attack a creature with this magic weapon and roll a 20 on the attack roll, the creature must make a DC 15 Wisdom saving throw in addition to suffering the attack’s normal effects. On a failed save, the creature also suffers the effects of a
Polymorph
spell. Roll a d20 and consult the following table to determine the form the target creature is transformed into.
d20
New Form
1
Tyrannosaurus
...
Remove Curse
spell or similar magic, you are unwilling to part with the weapon. Whenever you attack a creature with this weapon and roll a 1 on the attack roll, you suffer the effect of a
Polymorph
spell for 1 hour, rolling on the table to determine your new form.`,
    },
    {
      name: "Ruidium Weapon",
      rarity: "Very Rare",
      ...
      attunment: true,
      price: 2500,
      description: `This magic weapon has a dull, rusty color or has veins of ruidium running through it. While this weapon is on your person, you gain the following benefits:
...
This trident has 3 charges. You can expend 1 charge to cast
Control Water
(save DC 15) from the trident or 3 charges to cast
Tsunami
(save DC 15) from it instead. The trident regains 1d3 expended charges daily at dawn.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This weapon is bedecked in ornate gold filigree and deep-blue and maroon jewels. You gain a +1 bonus to attack and damage rolls made with this weapon. Additionally, you gain proficiency in the Intimidation and Persuasion skills if you don’t already have it.
