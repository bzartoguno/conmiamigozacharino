...
export const tribeSupremeSmithy: Tribe = {
  ...
  items: [
    {
      name: "Fire Resistance Mitt, Oven Mitts",
      rarity: "Uncommon",
      itemType: "Armor",
      attunment: false,
      price: 250,
      description: "Their just like regular oven mitts, what? You want to grab hot stuff with your hands? What's wrong with you?",
    },
    {
      name: "Full range of motion body maniquin",
      rarity: "Uncommon",
      itemType: "Armor",
      attunment: false,
      price: 250,
      description: "A Maniquin that can be posed to show off your old or new armor to show off to your friends or enemies. If you take this to my brother Goldhand I bet he'd be happy to give it a few verbal commands to follow, for free.",
    },
    {
      name: "Theif Resistant Armor Stand (Collapsible)",
      rarity: "Uncommon",
      itemType: "Armor",
      attunment: false,
      price: 250,
      description: "Lets you dry/clean armor properly at camp instead of piling it in a sad heap on the ground for robbers to steal",
    },
    {
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "Shield, +1 AC & +1 to your Raw Dex Score (Not modifier, to a max of 20)",
    },
    {
      name: "Leather",
      rarity: "Uncommon",
      ...
      attunment: false,
      price: 250,
      description: "Light, Your AC becomes 11+ Your Dex Score",
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "Light, Your AC becomes 12+ Your Dex Score",
    },
    {
      name: "Wizard's Robes",
      rarity: "Uncommon",
      ...
      attunment: false,
      price: 250,
      description: "Light, Your AC becomes 10+ Your Int Score (Max of 5)",
    },
    {
      name: "Barbarian's Fur",
      rarity: "Uncommon",
      itemType: "Armor",
      attunment: false,
      price: 250,
      description: "Medium, Your AC becomes 14+ Your Str Score (Max of 4)",
    },
    {
      name: "Breastplate",
      rarity: "Uncommon",
      ...
      attunment: false,
      price: 250,
      description: "Medium, Your AC becomes 14+ Your Dex Score (Max of 2)",
    },
    {
      name: "Chain Shirt",
      rarity: "Uncommon",
      ...
      attunment: false,
      price: 250,
      description: "Medium, Your AC becomes 13+ Your Dex Score (Max of 2)",
    },
    {
      name: "Hide",
      rarity: "Uncommon",
      ...
      attunment: false,
      price: 250,
      description: "Medium, Your AC becomes 12+ Your Dex Score (Max of 2)",
    },
    {
      name: "Tower Shield",
      rarity: "Rare",
    ...
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: "Light, Your AC becomes 11+ Your Dex Score, and disadvantage on Stealth",
    },
    {
      name: "Half Plate",
      rarity: "Rare",
      ...
      attunment: false,
      price: 1000,
      description: "Medium, Your AC becomes 15+ Your Dex Score (Max of 2), and disadvantage on Stealth",
    },
    {
      name: "Scale Mail",
      rarity: "Rare",
      ...
      attunment: false,
      price: 1000,
      description: "Medium, Your AC becomes 14+ Your Dex Score (Max of 2), and disadvantage on Stealth",
    },
    {
      name: "Chain Mail",
      rarity: "Rare",
      ...
      attunment: false,
      price: 1000,
      description: "Heavy, Your AC becomes 16, and disadvantage on Stealth",
    },
    {
      name: "Knight's Plate",
      rarity: "Rare",
      ...
      attunment: false,
      price: 1000,
      description: "Heavy, Your AC becomes 16+ Your Con Score (Max of 5), and disadvantage on Stealth",
    },
    {
      name: "Plate",
      rarity: "Rare",
      ...
      attunment: false,
      price: 1000,
      description: "Heavy, Your AC becomes 18, and disadvantage on Stealth",
    },
    {
      name: "Splint",
      rarity: "Rare",
      ...
      attunment: false,
      price: 1000,
      description: "Heavy, Your AC becomes 17, and disadvantage on Stealth",
    },
    {
      name: "Ring Mail",
      rarity: "Rare",
      ...
      attunment: false,
      price: 1000,
      description: "Heavy, Your AC becomes 14, and disadvantage on Stealth",
    },
    {
    ...
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: "You have a bonus to AC while wearing this armor. The bonus is determined by its rarity (This is a +1 item)",
    },
    {
...
10 | Thunder`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `While wearing this armor, you have resistance to one of the following damage types: bludgeoning, piercing, or slashing. The DM chooses the type or determines it randomly.
Curse. This armor is cursed, a fact that is revealed only when an Identify spell is cast on the armor or you attune to it. Attuning to the armor curses you until you are target by the Remove Curse spell or similar magic; removing the armor fails to end the curse. While cursed, you have vulnerability to two of the three damage types associated with the armor (not the one to which it grants resistance).`,
    ...
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `Tattoo Attunement. To attune to this item, you hold the needle to your skin where you want the tattoo to appear, pressing the needle there throughout the attunement process. When the attunement is complete, the needle turns into the ink that becomes the tattoo, which appears on the skin.
...
Rare | 15 + your Dexterity modifier (maximum of +2)`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `While holding this iron tower shield, you gain a +1 bonus to AC. This bonus is in addition to the shield's normal bonus to AC.
Additionally, the shield has 3 charges, and it regains 1d3 expended charges daily at dawn. If you are holding the shield and push a creature within your reach at least 5 feet away, you can expend 1 charge to push that creature an additional 10 feet, knock it prone, or both.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This burnished copper breastplate looks as if it were made of interlocking gears. Merchant’s scales are emblazoned across the chest.
...
The armor regains 1d4 expended charges daily at dawn.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This magic armor appears as a pot of bubbling black ichor. When you attune to it, the ichor adheres to and contours to your skin, and the pot disappears. The armor can be worn under normal clothes, and it doesn’t impede bodily functions. Once you put it on, it can’t be removed unless you choose to do so or you die, at which point the pot reappears and the ichor flows back into it.
While wearing the armor, you have resistance to poison damage. The armor also doesn’t impose disadvantage on Dexterity (Stealth) checks`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This colorful, flowery armor was forged in the Feywild and is infused with that plane’s captivating magic.
...
This armor has 3 charges. You can use an action to expend a charge to cast the Compulsion spell (save DC 15) from this armor. The armor regains 1d3 expended charges daily at dawn.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This intricate grayscale armor was forged in the Shadowfell and is infused with that plane’s gloom.
...
This armor has 3 charges. You can expend a charge to cast the Calm Emotions spell (save DC 15) from the armor. This armor regains 1d3 expended charges daily at dawn.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `Strange rituals have repurposed the body of a flesh golem into this partially sentient suit of leather armor. While wearing this armor, you gain a +1 bonus to AC and to saving throws against spells and other magical effects. In addition, you gain the following properties:
...
- Berserk. Whenever a critical hit is made against you, roll a d6. On a 6, the armor causes you to go berserk. On each of your turns while berserk, you attack the nearest creature you can see. If no creature is near enough to move to and attack, you attack an object, with preference for an object smaller than yourself. Once the armor causes you to go berserk, it cannot be removed. You continue to attack until you are incapacitated or until another creature is able to calm you with appropriate magic (such as a calm emotions spell) or a successful DC 15 Charisma (Persuasion) check.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: "This suit of armor is reinforced with a magically enhanced metal alloy called mizzium, which is made in Izzet foundries. While you're wearing the armor, any critical hit against you becomes a normal hit. In addition, when you are subjected to a magical effect that allows you to make a Strength or Constitution saving throw to take only half damage, you instead take no damage if you succeed on the saving throw.",
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This magical armor appears as a jug of molten bronze. When you attune to it, the bronze adheres and contours to your skin. The armor can be worn under normal clothes, but it doesn't impede bodily functions. Once you put it on, it can't be removed unless you choose to do so.
While wearing the armor, you have resistance to fire damage. The armor also doesn't impose disadvantage on Dexterity (Stealth) checks.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `Soldiers of the Boros Legion consider it an honor to bear this shield, even knowing that it might be the last honor they receive. The front of the shield is sculpted to depict a grieving human face.
...
Curse. This armor is cursed. Whenever you don or doff it, you must make a DC 15 Constitution saving throw, taking 100 (10d10 + 45) poison damage on a failed save, or half as much damage on a successful one. Only a Wish spell can remove the armor's curse.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: "While holding this shield, you have a bonus to AC determined by the shield's rarity. This bonus is in addition to the shield's normal bonus to AC. (This is a +2 item)",
    },
    {
...
Curse. This armor is cursed, and attuning to it extends the curse to you. As long as you remain cursed, you’re unwilling to part with the armor. Taking it off fails to end the curse. While cursed in this way, you feel disconnected from your body, continuously hearing whispers that call for you to join them. Whenever you finish a long rest while cursed, you must make a DC 11 Charisma saving throw. On a failed save, your soul is drawn from your body and trapped in an object on a different plane of existence. The object and location of this object are chosen by the DM (but might be the House of Cards; see chapter 18). While your soul is trapped in this way, your body is inert and doesn’t age or require sustenance. Destroying the object frees your soul; otherwise, only a Wish spell can restore your soul to your body.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This fine set of white-and-silver armor bears the wind rune upon its chest.
...
Invoking the Rune. As an action, you can invoke the armor’s rune to cast the Wind Wall spell (save DC 15) with it. Once the rune has been invoked, it can’t be invoked again until the next dawn.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `While wearing this armor, you can use it to cast either Speak With Dead or Animate Dead. Once the armor has cast a spell in this way, it can’t cast either spell until the next dawn.
Your soul keeps this armor together. If you die while you are attuned to the armor, the armor is destroyed.`,
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `This armor has 5 charges. While you wear it, you can use a bonus action to expend 1 or more charges to cast one of the following spells from the armor, targeting yourself: Jump (1 charge) or Levitate (2 charges).
...
A shield is made from wood or metal and is carried in one hand. Wielding a shield increases your Armor Class by 2. You can benefit from only one shield at a time.`,
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `This emblem is the symbol of a deity or a spiritual tradition. As an action, you can attach the emblem to a suit of armor or a shield or remove it.
...
The emblem regains all expended charges daily at dawn.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `This gleaming set of silver-and-gold plate armor never tarnishes.
...
Once this bonus action is used, it can’t be used again until the next dawn.`,
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "While holding this shield, you have advantage on initiative rolls and Wisdom (Perception) checks. The shield is emblazoned with the symbol of an eye.",
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "This suit of magic armor is made from shimmering scales. While wearing it, you can apply your full Dexterity modifier (instead of a maximum of +2) when determining your Armor Class. In addition, this armor does not impose disadvantage on your Dexterity (Stealth) checks.",
    },
    {
      name: "Shield, +1",
      rarity: "Uncommon",
      ...
      attunment: false,
      price: 250,
      description: "While holding this shield, you have a bonus to AC determined by the shield's rarity. This bonus is in addition to the shield's normal bonus to AC. (This is a +1 item)",
    },
    {
      ...
      attunment: true,
      price: 250,
      description: `While you are wielding this shield, you gain a +1 bonus to AC. This bonus is in addition to the shield’s normal bonus to AC.
Curse. This item is cursed. Attuning to it extends the curse to you until you are targeted by a Remove Curse spell or similar magic. You cannot discard the shield, and remain attuned to it, as long as you are cursed. As long as you are cursed, you are sluggish. Your speed is halved. When you roll initiative, treat the roll on your d20 as a 1. You can’t change your initiative by any means.`,
    ...
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `While wearing this armor, you can use your reaction to give yourself advantage on a saving throw you make against a spell. Once this property is used, it can’t be used again until the next dawn.
In addition, while you wear this armor, you can use it to cast Antimagic Field, requiring no spell components. Once this property is used, it can’t be used again until the next dawn.`,
    },
    {
      ...
      attunment: false,
      price: 2500,
      description: "You have a bonus to AC while wearing this armor. The bonus is determined by its rarity (This is a +2 item)",
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `Set in the center of this armor’s chest is a citrine engraved with the shield rune.
...
Very Rare | 18`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `The outside surface and internal joints of this armor whir with interlocking gears, drawing on the orderly magic of the plane of Mechanus.
...
Roll a d20 if you are wearing the helm and take fire damage as a result of failing a saving throw against a spell. On a roll of 1, the helm emits beams of light from its remaining gems. Each creature within 60 feet of the helm other than you must succeed on a DC 17 Dexterity saving throw or be struck by a beam, taking radiant damage equal to the number of gems in the helm. The helm and its gems are then destroyed.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This bulky, eyeless helmet is made for a pit fiend but magically resizes to fit the heads of other wearers.
...
property in the Nine Hells has a 20 percent chance of attracting a narzugon (see page 238), which arrives on the back of a nightmare mount in 1d4 hours. The narzugon tries to recover the helm, killing you if necessary to obtain it. If it gets the helm, the narzugon tries to deliver it to its infernal master.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `A number of Kwalish’s experiments were attempts to research the works of the legendary mage Heward, who first crafted what he named
Hireling Armor
...
, or a similar item instantly destroys both items and opens a gate to the Astral Plane. The gate originates where the one item was placed inside the other. Any creature within 10 feet of the gate is sucked through it and deposited in a random location on the Astral Plane. The gate then closes. The gate is one-way only and can’t be reopened.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `You gain a +1 bonus to AC while wearing this armor.
The coat has 3 charges. When you hit a creature with an attack and that creature doesn't have all its hit points, you can expend 1 charge to deal an extra 1d10 necrotic damage to the target. The coat regains 1d3 expended charges daily at dawn.`,
    },
    {
      ...
      attunment: false,
      price: 2500,
      description: `You have a +1 bonus to AC while wearing this armor, which shimmers softly.
If you die while wearing the armor, it is destroyed, and each celestial, fey, and fiend with 30 feet of you must succeed on a DC 15 Charisma saving throw or be banished to its home plane of existence, unless it is already there.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This hideous armor is formed from black chitin, beneath which veins pulse and red sinews glisten. To attune to this item, you must wear it for the entire attunement period, during which tendrils on the inside burrow into you.
...
causes the roof, the door, or one wall to regain 50 hit points.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This magic armor has a dull, rusty color or has veins of ruidium running through it. While you wear this armor, you gain the following benefits:
...
If the Apotheon is killed or redeemed, all of the ruidium in Exandria is destroyed instantly, and
Ruidium Armor
becomes
+1 Armor
.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `Shield, very rare (requires attunement)
...
If Ruidium Is Destroyed.
If the Apotheon is killed or redeemed, all the ruidium in Exandria is destroyed instantly, and a Ruidium Shield becomes a
+2 Shield
.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This crystalline blue shield is fashioned from a sapphire dragon’s scale and is created to aid in rooting out the influence of Aberrations. While wielding the shield, you have resistance to psychic and thunder damage. Also, when you take damage from a creature that is within 5 feet of you, you can use your reaction to deal 2d6 thunder damage to that creature.
As an action, you can use the shield to help you locate Aberrations until the end of your next turn. If any Aberrations are within 1 mile of you, the shield emits a low humming tone for a moment, and you know the direction of all Aberrations within that range. Once this property is used, it can’t be used again until the next dawn.`,
    },
    {
      ...
      attunment: false,
      price: 2500,
      description: "While holding this shield, you have a bonus to AC determined by the shield's rarity. This bonus is in addition to the shield's normal bonus to AC. (This is a +3 item)",
    },
    {
...
You can transfer the shield's magic to a nonmagical weapon by tracing the uven rune on the weapon with one finger. The transfer takes 8 hours of work that requires the two items to be within 5 feet of each other. At the end, the shield is destroyed, and the rune is etched or burned into the chosen weapon. This weapon becomes a rare magic item that requires attunement. It has the properties of a +1 weapon. The bonus increases to +3 when the weapon is used against one of the following creature types, chosen by you at the time of the magic weapon's creation: aberrations, celestials, constructs, dragons, elementals, fey, fiends, giants or undead.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `While wearing this skull-shaped helm, you have resistance to cold, poison, and necrotic damage.
Additionally, while wearing the helm, you can cast
Spirit of Death
from it without requiring material components. Once you use the helm to cast the spell, the helm can’t cast this spell again until the next dawn.`,
    },
    {
    ...
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `While you wear this helm, you gain a +1 bonus to AC and remain aware of your surroundings even while you're asleep, and you have advantage on Wisdom (Perception) checks that rely on sight.
As a bonus action, you can cast the
See Invisibility
