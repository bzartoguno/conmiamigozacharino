  ...
  items: [
    {
      ...
      attunment: false,
      price: 40,
      description: "(Doug Dimmadome hat from the Dimmsdale Dimmadome. Note",
    },
    {
      name: "Beep Beep",
      rarity: "Common",
      ...
      attunment: false,
      price: 40,
      description: "(A set of car keys; you can never find the car but can always hear it lock and unlock.)",
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "(A coupon that offers 50% off your next purchase anywhere; valid for one use only.)",
    },
    {
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "(A self-help book designed to improve both your mental and physical wellbeing.)",
    },
    {
      name: "Bonk",
      rarity: "Uncommon",
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "(Wand of pillows; using a charge on this wand can transform a 30-foot area into a pillow-ish version of that area. This effect lasts for 10 minutes.)",
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "(Hat of the WizBarb, whoever puts it on has their Intelligence and Strength scores swapped with one another.)",
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "Town Crier's cap, While wore become aware of every piece of news that a regular person living in the city or town you are in would be aware of. Like upcoming festivals, important events that take place in the city, or if there has been a particularly big scandal recently. You are also aware of who the major political figures of the city are. This hat does not give any information outside of a city or town.",
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: "(A normal +2 AC shield with a stick of dynamite attached to it. No, the dynamite can't be removed.)",
    },
    {
    ...
    },
    {
      ...
      attunment: true,
      price: 40,
      description: `An orb of shielding is a polished, spherical chunk of crystal or stone aligned to one of the planes of existence. If you're a spellcaster, you can use this orb as a spellcasting focus.
...
Xorian marble- Psychic`,
    ...
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `A Badge of the Watch is given only to those who have earned the trust of the Open Lord of Waterdeep. The badge, signifying the rank of captain in Waterdeep's City Watch, bears the emblem of Waterdeep and is meant to be worn or carried.
...
An enclosed creature can use its action to push against the sphere's wall, moving the sphere up to half the creature's walking speed. The sphere can be picked up, and its magic causes it to weigh only 1 pound, regardless of the weight of creatures inside.`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This pair of lightweight bronze bracers is lined with soft, purple velvet and engraved with swirling designs.
...
If your attunement to the lungs ends, your original lungs reappear.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `This brass war horn is engraved with the war rune, which glows purple when the horn is blown.
...
Rare | +2`,
    },
    {
      ...
      attunment: false,
      price: 250,
      description: `The cards of this deck shimmer around the edges. While holding this deck, you can use the following properties:
...
Uncommon | +1`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `Produced by a special needle, this tattoo shifts and wavers on the skin, parts of it appearing blurred.
Tattoo Attunement.
...
While wearing the bracers. whenever you cast a cantrip, you can use a bonus action on the same turn to cast that cantrip a second time.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `Produced by a special needle, this magic tattoo features symbols of life and rebirth.
Tattoo Attunement.
To attune to this item, you hold the needle to your skin where you want the tattoo to appear, pressing the needle there throughout the attunement process. When the attunement is complete, the needle turns into the ink that becomes the tattoo, which appears on the skin.
If your attunement to the tattoo ends, the tattoo vanishes, and the needle reappears in your space.
Necrotic Resistance.
...
When you would be reduced to 0 hit points, you drop to 1 hit point instead. Once used, this property can't be used again until the next dawn.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This soft, violet cap bears stitching in the pattern of folds on a brain.
...
Once this bonus action is used, it can’t be used again until the next dawn.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This thick, fur-lined cloak has the frost rune stitched on the hem in silvery blue thread. Frigid wind swirls around the cloak, regardless of the weather.
...
Once the rune has been invoked, it can’t be invoked again until the next dawn.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `The design of this bronze circlet resembles swirling clouds. At its center is set a deep-blue stone, upon which is inscribed the cloud rune.
...
If you paint a form of energy such as fire or lightning, the energy appears but dissipates as soon as you complete the painting, doing no harm to anything.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `This onyx sphere bears deep, spiraling grooves and dangles from an iron chain. While the orb is on your person, you gain the following benefits:
...
The orb is cursed, and becoming attuned to it extends the curse to you. As long as you remain cursed, you are unwilling to part with the orb, keeping it on your person at all times. All nonmagical flames within 30 feet of you automatically extinguish, and fire damage dealt by you is halved.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `While attuned to this device, you have a +1 bonus to Wisdom saving throws, and you can use an action to cast the
Dancing Lights
,
Guidance
, or
...
, its magic might function sporadically or with unpredictable side effects, as determined by the DM.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `Originally crafted for ground-bound giant brawlers to fight against dragons and other enormous predators of the sky, these studded gauntlets are engraved with the dragon rune.
