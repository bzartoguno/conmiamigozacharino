...
export const tribeOPapiesOracleReadings: Tribe = {
  ...
  items: [
    {
      name: "Fancy themed 52 play cards",
      rarity: "Uncommon",
      itemType: "Wondrous Item",
      attunment: false,
      price: 250,
      description: "A themed deck of 52 playing cards based on well anything you want. Papy already saw what you wanted and got it just for you. Great for card games, or just showing off.",
    },
    {
      name: "Homemade Incense & Candles to set the mood",
      rarity: "Uncommon",
      itemType: "Wondrous Item",
      attunment: false,
      price: 250,
      description: "Incense & Candle of any variety you want. Papy already saw what you wanted and pre made for you. That probably why Papy smells so nice.",
    },
    {
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "Get a vague hint at three possible endings to the current campaign—the worst, the best, and the current trajectory.",
    },
    {
      name: "Luside dream in a bottle",
      rarity: "Uncommon",
      itemType: "Wondrous Item",
      attunment: false,
      price: 250,
      description: "A small smokey vial containing that will open up your mind into the web of divination. Similar to 'Near Future Blessing' but you can down it anytime anywhere.",
    },
    {
...
Additionally, while holding the cards, you can cast Divination from them. Once this property is used, it can’t be used again until the next dawn`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `This writhing crystal is steeped in the warped essence of the Far Realm. As an action, you can attach the shard to a Tiny object (such as a weapon or a piece of jewelry) or detach it. It falls off if your attunement to it ends. You can use the shard as a spellcasting focus while you hold or wear it.
...
A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head.`,
    ...
    {
      name: "Sage's Signet (Fix this)",
      rarity: "Rare",
      itemType: "Ring",
      attunment: true,
      price: 1000,
      description: `This gilded ring bears a beautiful engraving and is imbued with powers of keen wisdom and foresight. While wearing this ring, you can use an action to cast the Augury spell from the ring. Once you use the ring to cast the spell, the ring can’t cast the spell again until the next dawn.
...
Sage’s Signet`,
    },
    {
      ...
      attunment: true,
      price: 1000,
      description: `Created by the stone giant librarians of Gravenhollow. this nineteen-inch-long shard of quartz grants you advantage on Intelligence (investigation) checks while it is on your person.
...
The crystal regains 1d6 + 4 expended charges daily at dawn. If you expend the crystal's last charge, roll a d20. On a 1, the crystal vanishes, lost forever.`,
    },
    {
      ...
      attunment: false,
      price: 250,
      description: `Created in the image of the Deck of Many Things, this deck of ivory or vellum cards bestows an assortment of minor benefits and penalties on those who draw from it. Most (75 percent) of these decks have only thirteen cards, but the rest have twenty-two.
...
Vulture*. One nonmagical item or piece of equipment in your possession (chosen by the DM) disappears. The item remains nearby but concealed for a short time, so it can be found with a successful DC 15 Wisdom (Perception) check. If the item isn’t recovered within 1 hour, it disappears forever.`,
    },
    {
      ...
      attunment: true,
      price: 2500,
      description: `While attuned to this device, you have a +1 bonus to Intelligence saving throws. The first time you attune to the chronolometer, you choose one language you don't know. You subsequently know that language while attuned to the device.
...
Part of a Whole. While this component is not installed in the Orrery of the Wanderer, its magic might function sporadically or with unpredictable side effects, as determined by the DM.`,
    },
    {
      ...
      attunment: false,
      price: 2500,
      description: `A Devastation Orb is an elemental bomb that can be created at the site of an elemental node by performing a ritual with an elemental weapon. The type of orb created depends on the node used. For example, an air node creates a Devastation Orb of Air. The ritual takes 1 hour to complete and requires 2,000 gp worth of special components, which are consumed.
