  ...
  items: [
    {
      ...
      attunment: false,
      price: 250,
      description: "Same as the last option, but you actually get a lock and key for your renforced room.",
    },
    {
    ...
    },
    {
      ...
      attunment: false,
      price: 250,
      description: "(Yes this is an actual thing) (We go and we pull out a stone from our hearth and you just wrap it in a blanket and go to sleep with it. It comes highly recommend from lonely single adventures- “It makes me feel like I'm sleeping next to someone.”)",
    },
    {
      name: "Room & Board",
      rarity: "Uncommon",
      ...
      attunment: false,
      price: 250,
      description: "This includes breakfast, lunch, and dinner, and lasts 24 hours.",
    },
    {
...
Stirring (Rare). In addition to the options for a Slumbering vessel, you can fill a Stirring vessel with Mead, a Potion of Fire Breath, or a Greater Potion of Healing.`,
    },
    {
      ...
      attunment: false,
      price: 1000,
      description: `A professor orb is a smooth 5-pound sphere of smoky gray quartz about the size of a grapefruit. Close examination reveals two or more pinpricks of silver light coming from deep inside the sphere.
...
Slumbering (Uncommon). As a bonus action, if the vessel is empty, you can speak the command word to fill the vessel with one of the following (your choice): Ale, Olive Oil, a Potion of Healing, or a Potion of Climbing. Once this property is used, it can’t be used until the next dawn. A potion you create in this way loses its magical properties if it isn’t imbibed within 24 hours.`,
    },
    {
      ...
      attunment: false,
      price: 2500,
      description: `An abracadabrus is an ornate, gemstone-studded wooden chest that weighs 25 pounds while empty. Its interior compartment is a cube measuring 1 1/2 feet on a side.
