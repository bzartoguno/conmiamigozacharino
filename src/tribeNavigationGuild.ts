...
export const tribeNavigationGuild: Tribe = {
  ...
  priceVariability: 0,
  insults: [
          "Quick thing, our town runs a little stamp challenge for traveling parties. It’s meant to keep groups working together instead of talking past each other. Before you lock in a plan, ask one of your companions what they want to do next or what part they want to take.  |  Stamp Quest (Ask First): Before making a plan, ask another PC what they want to do next or what they want to do for their part in de plan. | Reward: 3 Stamps",
          "Since you look like de capable sort, I’ll share one of our stamp challenges. It rewards teamwork over heroics. Next time trouble starts, set up a simple two-person combo with a companion, nothing fancy, just coordinated.  |  Stamp Quest (Tag-Team): Coordinate a 2-person combo in combat (grapple + shove, distraction + sneak, buff + big hit, etc.). | Reward: 5 Stamps",
          "I’ve got a small stamp challenge that’s been good for keeping parties sharp and in sync. When a companion offers an idea, don’t just agree, add to it. Build on what they said and keep de momentum going.  |  Stamp Quest (Yes, And): Say 'Yes, and-' (or de spirit of it) to another player’s idea and build on it. | Reward: 3 Stamps",
          "Alright, here’s a fun little stamp challenge purely for morale. Pick a light accent or a harmless speech quirk and use it in a couple of conversations  |  Stamp Quest (Tiny Accent): Use a very light accent or speech quirk for two separate conversations. If de DM calls it out, fail. | Reward: 3 Stamps",
          "Elo friend welcome to Navigation Guild, if you got a place to be then let us show you de way. Much like our anseters of old did.",
          "Thank you friend for choosing us we know de road can be quite dangerous but here we make sure that our customers aren't harassed by anyone or anything during their journy.",
          "MY FRIEND IT IS SO GOOD TO SEE YOU AGAIN! PLEASE SIT! SIT! I MUST HEAR MORE ABOUT YOUR TRAVEL!",
          "My friend! My friend! My friend! Welcome! Welcome! Welcome! You are among family at last! I may be trying to run a busniess here but I am so happy to see you again!",
          ...
          "Greeting friend would you be interested in learning more about de world around you, if so please follow me! and I will teach you what is safe to eat while on de road! Make a DC 14 Nature check to see what you learn. If you succeed, congrate! you learned more about herbs and various plants to eat while out in nature!. If you fail, you take 1 point of damage from Nate's ramblings.",
          ],
  items: [
    {
      name: "One town over",
