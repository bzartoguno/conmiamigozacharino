...
export const tribeOPapiesOracleReadings: Tribe = {
  ...
  items: [
    ...
    },
    {
      ...
      price: 2250,
      description:
        "A small smokey vial containing that will open up your mind into the web of divination. Similar to 'Near Future Blessing' but you can down it anytime anywhere.",
    },
    {
