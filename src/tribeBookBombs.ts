...
export const tribeBookBombs: Tribe = {
  ...
  items: [
    ...
    },
    {
      ...
      price: 5,
      description:
        "A classic people-skills guide with painfully practical tips for negotiation, charm, and not getting stabbed in group projects.",
    },
    {
    ...
    },
    {
      ...
      price: 3,
      description:
        "A scandalous romance with velvet masks, dangerous bargains, and enough longing to fog a ballroom.",
    },
    {
      name: "The Very Hungry Tarrasque",
      price: 2,
      description:
        "A colorful children’s book about snacks, manners, and why we do not feed things that can eat castles.",
    },
