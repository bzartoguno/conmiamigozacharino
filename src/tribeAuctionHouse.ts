...
export const tribeAuctionHouse: Tribe = {
  ...
  items: [
    {
      name: "Applegarth Guild's The Silver Tongue Contract",
      price: 4500,
      description: "Creates an unbreakable agreement between parties, with divine punishment for breaking the terms."
    },
    {
      name: "Archives Guild's The Lost Ledger of Legend",
      price: 8000,
      description: "A complete list of lost legendary items, providing clues, riddles, and maps to start your journey."
    },
    {
      name: "Book Bomb's The Codex of the Inferno",
      price: 7500,
      description: "Creates a firestorm in a 100-foot radius dealing 10d6 fire damage lasting 1d6+1 days. Heat Metal effect follows. Reforms after one month."
    },
    {
    ...
    },
    {
      ...
      price: 7000,
      description: "Rewinds time by one hour, keeping all memories intact. Usable once per megaannum."
    },
    {
    ...
    },
    {
      ...
      price: 10000,
      description: "Enhances crafted weapons and armor to near-legendary status, granting +3 to stats with a chance of an additional special ability."
    },
    {
      name: "Will's Weapon's Phantom Whip of the Ghost King",
      price: 8000,
